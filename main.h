...
va_list list, char output_buffer[], int flags, int width, int precision, int size);
...
char output_buffer[], int flags, char flag_ch, int width, int precision, int size);

/* Function to print non printable characters */
int print_non_printable(va_list types, char output_buffer[],
	int flags, int width, int precision, int size);
...
int print_reverse(va_list types, char output_buffer[],
	int flags, int width, int precision, int size);

/*Function to print a string in rot 13*/
int print_rot13string(va_list types, char output_buffer[],
	int flags, int width, int precision, int size);

/* width handler */
int handle_write_char(char c, char output_buffer[],
	int flags, int width, int precision, int size);
int write_number(int is_positive, int ind, char output_buffer[],
	int flags, int width, int precision, int size);
int write_num(int ind, char bff[], int flags, int width, int precision,
	int length, char padd, char extra_c);
int write_pointer(char output_buffer[], int ind, int length,
